    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/users/{slug}").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/users").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/todos/{id}").authenticated()
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/api/todos/delete/{id}").authenticated()
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/todos/edit/{id}").authenticated()
